...
const GRADIENT_PRESETS = [
  ...
  { name: 'Forest Dew', css: 'linear-gradient(135deg, #14b8a6, #10b981)', idx: 3 },
  { name: 'Blaze Rose', css: 'linear-gradient(135deg, #f43f5e, #fb923c)', idx: 4 },
];

const mockApiKeys = [
  { id: 'key_1', name: 'ZC-PROD-01', key: 'zc_live_k8x2...m4p7', fullKey: 'zc_live_k8x2a1b2c3d4e5f6m4p7', created: 'Dec 15, 2024', lastUsed: '2 hours ago' },
  { id: 'key_2', name: 'ZC-STAGE-02', key: 'zc_test_j3w9...q1r5', fullKey: 'zc_test_j3w9a1b2c3d4e5f6q1r5', created: 'Jan 3, 2025', lastUsed: '1 day ago' },
  { id: 'key_3', name: 'ZC-READ-03', key: 'zc_read_n7v4...t8y2', fullKey: 'zc_read_n7v4a1b2c3d4e5f6t8y2', created: 'Jan 10, 2025', lastUsed: '5 days ago' },
];
...
export default function SettingsHub() {
  ...
  const copyKey = (id: string) => {
    ...
    if (found) {
      navigator.clipboard.writeText(found.fullKey);
      setCopiedKey(id);
  ...
  const handleExportData = () => {
    const blob = new Blob(
      [JSON.stringify({ exportDate: new Date().toISOString(), data: 'mock-export' }, null, 2)],
    ...
    <div className="animate-fade-in-up space-y-8 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Manage your profile, theme, notifications, and preferences
        </p>
      </div>
      ...
      <div className="glass-card p-8 rounded-2xl">
        ...
        <p className="text-sm text-muted-foreground mb-5">
          Choose a gradient theme for your dashboard
        </p>
      ...
      <div className="glass-card p-8 rounded-2xl">
        ...
        <div className="space-y-5">
          {NOTIFICATION_ITEMS.map((item) => (
            <div
              key={item.key}
              className="flex items-center justify-between p-4 rounded-lg bg-white/[0.03] hover:bg-white/[0.05] transition-colors"
            >
              <div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Dialog open={addKeyDialogOpen} onOpenChange={setAddKeyDialogOpen}>
            <DialogTrigger asChild>
              <Button
                size="sm"
                className="gradient-bg-1 text-foreground font-semibold hover:opacity-90 transition-opacity"
              >
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge
                      variant="outline"
                      className="border-white/10 text-foreground cursor-pointer hover:bg-white/[0.05]"
                    >
                      Read
                    </Badge>
                    <Badge
                      variant="outline"
                      className="border-white/10 text-muted-foreground cursor-pointer hover:bg-white/[0.05]"
                    >
                      Trade
                    </Badge>
                    <Badge
