  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside className={`hidden lg:flex flex-col h-screen sticky top-0 transition-all duration-500 ease-out ${sidebarOpen ? 'w-60' : 'w-16'}`}>
        <div className="glass-card-3d flex flex-col h-full rounded-none border-r border-white/[0.06] p-2">
              ...
              return (
                <motion.button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 group relative ${
                    isActive ? 'nav-item-active' : 'text-muted-foreground hover:text-foreground hover:bg-white/[0.04]'
                  }`}
                ...
                >
                  <Icon className={`w-4.5 h-4.5 flex-shrink-0 transition-colors duration-300 ${
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-0 top-0 bottom-0 w-64 z-50 glass-card-3d rounded-none border-r border-white/[0.06] p-3"
            >
              ...
              <nav className="space-y-0.5">
                {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={`w-4.5 h-4.5 ${isActive ? 'text-amber-400' : ''}`} />
      ...
      <main className="flex-1 min-h-screen flex flex-col">
        {/* Top Bar */}
        <header className="sticky top-0 z-30 glass-card rounded-none border-b border-white/[0.06] px-4 md:px-6 py-3">
        ...
        {/* Footer */}
        <footer className="glass-card rounded-none border-t border-white/[0.06] px-4 py-3 mt-auto">
